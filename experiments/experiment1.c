...
arpra_uint p_in1_size = 50;
double p_in1_freq = 5.0;
...
int main (int argc, char *argv[])
{
    ...
    // Parse args
    p_in1_size = atoi(argv[1]);
    p_in1_freq = atof(argv[2]);

    // Synapse group sizes
    p_syn_exc_size = p_in1_size * p_nrn1_size;
    p_syn_inh_size = 0;
