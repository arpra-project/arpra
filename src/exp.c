...
void arpra_exp (arpra_range *z, const arpra_range *x)
{
    ...
    if (mpfr_zero_p(&(x->radius))) {
        ...
        // Domain is OK.
            ...
            mpfr_exp(&temp, &(x_range.left), MPFR_RNDN);
            ...
            mpfr_exp(&temp, &(x_range.left), MPFR_RNDU);
