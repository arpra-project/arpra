/*
 * t_sub.c -- Test the mpfa_sub function.
 *
...
int main (int argc, char *argv[])
{
    ...
    for (n_fail = 0, i = 0; i < n_tests; i++) {
        ...
        // Compute z.
        mpfa_sub(z_A, x_A, y_A);
        mpfi_sub(z_I, x_I, y_I);
